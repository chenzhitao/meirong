  ...
  <div class="app-container">
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
          ...
          </el-form-item><el-form-item label="角色" prop="roleIds">
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body :close-on-click-modal="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="所属门店" prop="sourceShopArray">
              <el-select v-model="form.sourceShopArray" placeholder="请选择所属门店" multiple>
                <el-option
          ...
          <el-col :span="12">
              <el-form-item label="技师等级" prop="consultantRank" v-show="form.roleIds && form.roleIds.toString().indexOf('101')!=-1">
...
import {listAllShopinfo, listShopinfo} from "@/api/shop/shopinfo";
...
export default {
  ...
  created() {
    ...
    this.getDicts("sys_user_type").then(response => {
      this.sysUserTypeOptions = response.data;
    });
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getUser(userId).then(response => {
        ...
        if(response.data.sourceShop){
          let shopArray=response.data.sourceShop.split(",");
          this.$set(this.form,'sourceShopArray',shopArray);
        }
        this.open = true;
        this.title = "修改用户";
        this.form.password = "";
    ...
    submitForm: function() {
      this.$refs["form"].validate(valid => {
        if (valid) {
          if(this.form.sourceShopArray.length>0){
            this.form.sourceShop=this.form.sourceShopArray.join(",");
          }
