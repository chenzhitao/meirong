...
import com.jiumi.pay.wxpay.enums.WxApiType;
import com.jiumi.pay.wxpay.enums.WxDomain;
...
public class WxPayApi {
    ...
    public static String v3Execution(RequestMethod method, String urlPrefix, String urlSuffix, String mchId, String serialNo, String keyPath, String body, String nonceStr, long timestamp, String authType) throws Exception {
        ...
        // 获取商户私钥
        String key = PayUtil.getPrivateKey(keyPath);
        // 生成签名
        String signature = RsaUtil.encryptByPrivateKey(buildSignMessage, key);
        // 根据平台规则生成请求头 authorization
        String authorization = PayUtil.getAuthorization(mchId, serialNo, nonceStr, String.valueOf(timestamp), signature, authType);
    ...
    public static String getSignKey(String mch_id, String partnerKey, SignType signType) {
        ...
        String nonce_str = WxPayUtil.generateStr();
    ...
    public static String doGet(String url, String authorization, Map<String, Object> params) {
        return HttpUtil.getDelegate().get(url, authorization, params);
    }

    public static String doPost(String url, String authorization, String data) {
        return HttpUtil.getDelegate().post(url, authorization, data);
    }
