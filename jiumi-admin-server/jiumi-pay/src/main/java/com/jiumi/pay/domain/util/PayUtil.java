...
public class PayUtil {
    ...
    public static String hmacSha256(String data, String key) {
        return SecureUtil.hmac(HmacAlgorithm.HmacSHA256, key).digestHex(data, CharsetUtil.parse(CharsetUtil.UTF_8));
    }
    ...
    public static String getPrivateKey(String apiClientKeyPath) throws Exception {
        ...
        String privateKey = originalKey
                ...
                .replaceAll("\\s+", "");
        return RsaUtil.getPrivateKeyStr(RsaUtil.loadPrivateKey(privateKey));
    }
