...
public class WxPayUtil {
    ...
    public static String hmacSha256(String data, String key) {
        return PayUtil.hmacSha256(data, key);
    }

    public static String md5(String data) {
        return PayUtil.md5(data);
    }
    ...
    public static String decryptData(String base64Data, String key) {
        return PayUtil.decryptData(base64Data, key);
    }
    ...
    public static String encryptData(String data, String key) {
        return PayUtil.encryptData(data, key);
    }

    public static String generateStr() {
        return PayUtil.generateStr();
    }
    ...
    public static StringBuilder forEachMap(Map<String, String> params, String prefix, String suffix) {
        return PayUtil.forEachMap(params, prefix, suffix);
    }
    ...
    public static Map<String, String> xmlToMap(String xmlStr) {
        return PayUtil.xmlToMap(xmlStr);
    }
    ...
    public static String bizPayUrl(String partnerKey, String appId, String mchId, String productId, String timeStamp, String nonceStr, SignType signType) {
        ...
        map.put("nonce_str", StringUtils.isEmpty(nonceStr) ? PayUtil.generateStr() : nonceStr);
    ...
    public boolean verifyV3Notify(HttpServletRequest request, String publicKey) throws Exception {
        ...
        String buildSignMessage = PayUtil.buildSignMessage(timestamp, nonceStr, body);
        String signatureStr = RsaUtil.encryptByPublicKey(buildSignMessage, publicKey);
