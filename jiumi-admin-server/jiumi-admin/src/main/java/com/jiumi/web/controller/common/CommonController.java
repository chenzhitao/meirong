package com.jiumi.web.controller.common;
...
import com.jiumi.framework.config.ServerConfig;
...
public class CommonController
{
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request)
    {
        try
        {
            ...
            String filePath = JiumiConfig.getDownloadPath() + fileName;
    ...
    public AjaxResult uploadFile(MultipartFile file) throws Exception
    {
        try
        {
            ...
            ajax.put("fileName",JiumiConfig.getDomainUrl()+ fileName);
            ajax.put("url",JiumiConfig.getDomainUrl()+ fileName);
            return ajax;
        }
        catch (Exception e)
        {
            ...
            throws Exception
    {
        try
        {
            ...
            // 本地资源路径
            String localPath = JiumiConfig.getProfile();
            // 数据库资源地址
