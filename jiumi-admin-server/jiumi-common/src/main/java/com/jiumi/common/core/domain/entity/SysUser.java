package com.jiumi.common.core.domain.entity;
...
import com.jiumi.common.annotation.Excel.ColumnType;
import com.jiumi.common.annotation.Excel.Type;
import com.jiumi.common.annotation.Excels;
...
public class SysUser extends BaseEntity
{
    ...
    //顾问等级
    private Long consultantRank;
    private String consultantRankName;
    ...
    public String getConsultantRankName() {
        return consultantRankName;
    }

    public void setConsultantRankName(String consultantRankName) {
        this.consultantRankName = consultantRankName;
    }

    public Long getConsultantRank() {
        return consultantRank;
    }

    public void setConsultantRank(Long consultantRank) {
    ...
    public void setSignUpTimes(int signUpTimes) {
