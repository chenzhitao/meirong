package com.jiumi.common.utils.file;
...
import com.jiumi.common.exception.file.FileNameLengthLimitExceededException;
import com.jiumi.common.exception.file.FileSizeLimitExceededException;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = JiumiConfig.getProfile();
     ...
     * @param pathFileName 文件路径
     * @return
     */
    private static void uploadToOss(InputStream inputStream, String pathFileName) {
        try {
...
// 关闭OSSClient。
    ...
    {
        int dirLastIndex = JiumiConfig.getProfile().length() + 1;
